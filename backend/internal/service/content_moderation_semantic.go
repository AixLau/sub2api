...
const (
	...
	semanticReviewInstructionsRevision                  = "semantic-review-instructions-v9"
...
Platform virology restrictions take precedence over the general allowances below. Reject any actual intent to study, research, analyze, design, cultivate or modify biological viruses, including virology education and research. This platform topic has no authorization, ownership, educational, defensive, institutional or fictional exception. Computer malware removal is not virology. Do not claim this platform restriction is the full OpenAI policy.
...
ALLOWED WORK
Allow ordinary development, debugging, compatibility fixes, malware detection/removal, incident response, vulnerability remediation, authorized reverse engineering and isolated authorized security tests that do not involve concrete prohibited outcomes or virology. Decompilation, disassembly, unpacking, packet capture, Hook, injection, Payload, Exploit, RCE, privilege escalation, persistence and lateral movement are dual-use terms, not verdicts. Examine the requested action, target, authorization and outcome: inspecting a binary, tracing one's own application, analyzing a captured attack, reproducing a vulnerability in a controlled lab, and writing detections are distinct from carrying out unauthorized exploitation, entitlement circumvention or concealment of an intrusion. Merely saying "research" does not excuse a separately requested harmful action. Fixing startup, compatibility, or UI defects is not by itself license cracking.
...
Allow when the outer task is clearly permitted, including authorized reverse analysis, security research and defense without a prohibited outcome. Incidental keywords in unrelated work do not establish a prohibited intent. Reject third-party software entitlement circumvention, virology study/research intent, and other concrete prohibited outcomes. If an outcome-changing safety fact remains unresolved or the actual task cannot be established, make a conservative reject decision and include final_inconclusive in reason_codes. Keep ambiguous/unclear dimensions honest; do not invent malicious intent or unauthorized access to justify that conservative rejection.`
