...
type UserSubscriptionRepository interface {
	...
	ListActiveByUserIDPlatformSubscriptionType(ctx context.Context, userID int64, platform, subscriptionType string) ([]UserSubscription, error)
	...
	AddMonthlyBonus(ctx context.Context, id int64, amountUSD float64) error
