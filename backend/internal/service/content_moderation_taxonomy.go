...
func canonicalSemanticReviewReasonCode(value string) string {
	...
	switch key {
	case "semantic_policy_public_harmless", "semantic_policy_reject", "unstructured_model_output", "invalid_model_output_json":
		return key
	...
	case "hate", "hateful":
		return "hate"
	case "benign_context", "benign", "safe", "public_market_data", "authorized_testing":
		return "benign_context"
