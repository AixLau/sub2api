...
func TestAuthService_Register_Success(t *testing.T) {
	...
	require.GreaterOrEqual(t, user.WelcomeReward, 1.0)
	require.LessOrEqual(t, user.WelcomeReward, 5.0)
	require.Equal(t, 3.5+user.WelcomeReward, user.Balance)
...
func TestAuthService_Register_UsesEmailAuthSourceDefaultsWhenGrantEnabled(t *testing.T) {
	...
	require.NoError(t, err)
	require.NotNil(t, user)
	require.Equal(t, 12.5+user.WelcomeReward, user.Balance)
...
func TestAuthService_Register_GrantOnSignupMergesSourceOverridesWithGlobalDefaults(t *testing.T) {
	...
	require.NoError(t, err)
	require.NotNil(t, user)
	require.Equal(t, 9.5+user.WelcomeReward, user.Balance)
