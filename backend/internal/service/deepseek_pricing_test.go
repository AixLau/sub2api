...
// ---------------------------------------------------------------------------
// deepseekPeakMultiplierAt：官方峰谷口径（2026-08-16 16:00 UTC 起生效）
...
func TestIsDeepSeekModel(t *testing.T) {
	...
	nonDeepseek := []string{
		...
		"deepseek-v3-2-251201", "deepseek-coder", "deepseek-foo", // 未知价卡保持 fail-closed
		"", " deepseek", // 无连字符后缀
	}
...
func TestGetModelPricing_UnknownDeepseekFailsClosed(t *testing.T) {
	...
	for _, m := range []string{"deepseek-v3-2-251201", "deepseek-coder", "deepseek-foo"} {
