...
func (s *ContentModerationService) GetStatus(ctx context.Context) (*ContentModerationRuntimeStatus, error) {
	...
	return &ContentModerationRuntimeStatus{
		...
		EffectiveProtection:          s.buildContentModerationEffectiveProtectionStatus(cfg, riskEnabled, routeCoverage, flaggedHashCount),
...
func (s *ContentModerationService) buildContentModerationEffectiveProtectionStatus(cfg *ContentModerationConfig, riskEnabled bool, routeCoverage ContentModerationRouteCoverageStatus, flaggedHashCount int64) ContentModerationEffectiveProtectionStatus {
	if cfg == nil {
