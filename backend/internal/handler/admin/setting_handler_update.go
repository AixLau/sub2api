...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		ShowUserUsageRanking: func() bool {
			if req.ShowUserUsageRanking != nil {
				return *req.ShowUserUsageRanking
			}
			return previousSettings.ShowUserUsageRanking
		}(),
	...
	payload := dto.SystemSettings{
		...
		ShowUserUsageRanking:        updatedSettings.ShowUserUsageRanking,
	}
