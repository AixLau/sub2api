...
WITH bounds AS (
  SELECT
    date_bin($1::interval, $3::timestamptz, TIMESTAMPTZ '1970-01-01 00:00:00+00') AS start_at,
    date_bin($1::interval, $4::timestamptz - INTERVAL '1 microsecond', TIMESTAMPTZ '1970-01-01 00:00:00+00') + $1::interval AS end_at
)`
...
SELECT date_bin($1::interval, m.bucket_start, TIMESTAMPTZ '1970-01-01 00:00:00+00'), $2::integer,
...
` + channelMonitorV2FixedRollupBoundsSQL + `
SELECT date_bin($1::interval, h.bucket_start, TIMESTAMPTZ '1970-01-01 00:00:00+00'), $2::integer,
...
` + channelMonitorV2FixedRollupBoundsSQL + `
SELECT date_bin($1::interval, e.bucket_start, TIMESTAMPTZ '1970-01-01 00:00:00+00'), $2::integer,
