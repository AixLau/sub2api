...
func userEntityToService(u *dbent.User) *service.User {
	...
	out := &service.User{
		...
		Role:                       u.Role,
		Balance:                    u.Balance,
		WelcomeReward:              u.WelcomeRewardAmount,
		SurpriseReward:             u.SurpriseRewardAmount,
		SurpriseRewardCheckedAt:    u.SurpriseRewardCheckedAt,
		SurpriseRewardAwardedAt:    u.SurpriseRewardAwardedAt,
