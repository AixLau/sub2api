...
func registerRoutes(
	...
	v1 := r.Group("/api/v1")
	publicTransit := handler.NewPublicTransitHandler(service.NewPublicTransitService(), h.ChannelMonitorV2, settingService)
	...
	routes.RegisterClientSetupRoutes(v1, h.ClientSetup, jwtAuth)
	...
	routes.RegisterMerchantSSOAPIRoutes(v1, h.MerchantSSOAPI)
