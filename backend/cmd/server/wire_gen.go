...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	clientSetupHandler := handler.NewClientSetupHandler(redisClient, apiKeyService)
	...
	contentModerationService := service.ProvideContentModerationService(settingRepository, contentModerationRepository, contentModerationOutboxRepository, contentModerationHashCache, groupRepository, accountRepository, userRepository, apiKeyAuthCacheInvalidator, emailService, secretEncryptor, serviceBuildInfo)
