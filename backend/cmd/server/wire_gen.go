...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	credentialImportHandler := admin.NewCredentialImportHandler(credentialImportService, credentialPrincipalCreator)
