<template>
  <AppLayout>
    ...
    <div v-if="draft && activeTab === 'config'" class="fixed inset-x-0 bottom-0 z-30 border-t border-line-default bg-surface-panel/95 px-4 py-3 shadow-glass backdrop-blur lg:left-64">
