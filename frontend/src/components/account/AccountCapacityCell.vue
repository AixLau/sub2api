<template>
  <div class="flex flex-col gap-0.5">
    <InstanceCapacitySummary v-if="account.principal" :principal="account.principal" />
    <!-- 并发槽位 -->
    <CapacityBadge v-if="!account.principal" :color-class="concurrencyClass" :current="currentConcurrency" :max="account.concurrency">
