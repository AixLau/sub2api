    ...
    >
      ...
      >
        ...
        >
          <div class="p-4">
            <div class="flex items-start gap-3">
              ...
              <button
                ...
                class="-m-1 flex-shrink-0 rounded p-1 text-content-disabled transition-colors hover:bg-surface-subtle hover:text-content-secondary"
          ...
          <!-- Progress bar -->
          <div v-if="toast.duration" class="h-1 bg-surface-subtle">
            <div
