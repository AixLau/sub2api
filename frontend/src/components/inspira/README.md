...
| `LiquidGlass` | `radius=16` · `border=0.07` · `lightness=50` · `alpha=0.93` · `blur=11` · `scale=-180` · `frost=0.03` | SVG 置换滤镜液态玻璃;Chromium 使用折射效果,Safari/Firefox 使用不透明纯白卡片 |
| `LiquidGlassBackdrop` | 无 | 液态玻璃预览与正式联系客服弹窗共享的无点阵透明雾化玻璃背景，不覆盖页面原色 |
