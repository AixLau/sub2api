...
export const METHOD_ORDER = ['alipay', 'alipay_direct', 'wxpay', 'wxpay_direct', 'stripe', 'airwallex', 'nineplus', 'haozpay'] as const
...
export const WEBHOOK_PATHS: Record<string, string> = {
  ...
  haozpay: '/api/v1/payment/webhook/haozpay',
}
...
export const PROVIDER_CALLBACK_PATHS: Record<string, CallbackPaths> = {
  ...
  haozpay: { notifyUrl: WEBHOOK_PATHS.haozpay, returnUrl: RETURN_PATH },
