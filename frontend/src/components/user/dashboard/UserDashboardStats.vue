...
const cards = computed<DashboardCard[]>(() => {
  ...
  return [
    ...
    },
    {
      ...
      value: `${formatMoney(stats.today_actual_cost, 4)} / ${formatMoney(stats.today_cost, 4)}`,
      description: `${t('common.total')}: ${formatMoney(stats.total_actual_cost, 4)} / ${formatMoney(stats.total_cost, 4)}`,
      icon: 'dollar',
      theme: 'purple',
      accent: 'value',
      decorativeChart: 'wave',
