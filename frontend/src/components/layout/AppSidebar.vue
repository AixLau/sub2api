...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/merchant-services', label: t('nav.merchant'), icon: GlobeIcon },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/merchant-integrations', label: t('nav.merchantIntegrations'), icon: GlobeIcon, hideInSimpleMode: true },
