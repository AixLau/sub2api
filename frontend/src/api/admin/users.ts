 ...
 * @param type - Optional type filter (balance, affiliate_balance, admin_balance, welcome_scratch, surprise_scratch, concurrency, admin_concurrency, subscription)
