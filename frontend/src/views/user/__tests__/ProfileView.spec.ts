...
describe('ProfileView', () => {
  ...
  it('renders the simplified single-column profile shell without separate stat cards', async () => {
    const wrapper = mount(ProfileView, {
      global: {
        stubs: {
          ...
          ProfileMotionPreferencesCard: { template: '<div data-testid="profile-motion-preferences-card" />' },
    ...
    expect(wrapper.get('[data-testid="profile-shell"]').html()).toContain('profile-motion-preferences-card')
