...
.custom-scrollbar {
  ...
  scrollbar-color: rgb(var(--color-content-disabled) / 0.3) transparent;
}
...
.custom-scrollbar::-webkit-scrollbar-thumb {
  background-color: rgb(var(--color-content-disabled) / 0.3);
  border-radius: 3px;
}

.custom-scrollbar::-webkit-scrollbar-thumb:hover {
  background-color: rgb(var(--color-content-disabled) / 0.5);
}
</style>
