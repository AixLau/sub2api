...
const colors = computed(() => {
  ...
  return {
    ...theme,
    red: chartSeriesColors.danger,
    redAlpha: colorWithAlpha(chartSeriesColors.danger, 0.12),
    purple: chartSeriesColors.contrast,
    purpleAlpha: colorWithAlpha(chartSeriesColors.contrast, 0.12),
    gray: theme.text,
  }
})
