    ...
    global: {
      stubs: {
        ...
        LandingShell: {
          ...
          template: '<main><router-link v-if="showModelPlazaEntry" to="/model-plaza" /><slot /></main>',
        },
        HeroSection: { template: '<div class="terminal-container" />' },
        TrustedBySection: { template: '<div />' },
      },
    },
  })
}
