...
"reconcile": "核对未知执行（最多显示 100 条）", "selectLease": "选择待核对执行", "evidence": "可信终结证据", "reason": "处置原因", "confirmTerminal": "我已核对上游，确认该执行已可靠终结。", "releaseConfirmed": "按终结证据释放占用", "wait": {"PRINCIPAL_CONCURRENCY_EXCEEDED": "账号满载", "INSTANCE_CONCURRENCY_EXCEEDED": "实例满载", "USER_CONCURRENCY_EXCEEDED": "用户容量不足", "REFRESH_WAIT": "等待凭证刷新", "COOLDOWN": "实例冷却", "INSTANCE_UNAVAILABLE": "实例生命周期处理中", "FAIRNESS_WAIT": "等待公平队列"},
 ...
 restart: '重新开始授权',
  "accountLimit": "账号总并发上限",
  "name": "实例名称",
  "maxConcurrency": "实例最大并发",
  "add": "添加实例",
  "shrinking": "缩容中，超出 {count}",
  "authorizationHint": "每个实例维护独立授权和安装身份。新增实例不会改变已保存的账号总并发上限。",
  "pendingCreation": "授权已验证，创建操作待完成。可重试恢复同一结果。",
  "pendingVerification": "授权已保存，身份待验证；验证通过前不参与调度。",
  "resumeOperation": "确认并恢复创建",
  "createSeparate": "添加为新账号",
  "drain": "停止接收新会话",
  "resume": "恢复接收请求",
  "remove": "安全归档实例",
  "reauthorize": "重新授权",
  "refreshCredential": "刷新凭证",
  "bindings": "有效会话绑定：{count}",
  "runtime": "运行 {running} · 预留 {reserved} · 待核对 {unknown} · 等待 {queued}",
  "savePreview": "当前占用 {occupied}，保存后账号上限 {limit}，预计超出 {overhang}。在途工作自然完成。",
  "drainAccount": "排空账号",
  "resumeAccount": "恢复账号",
  "archiveAccount": "归档账号",
  "stale": "刷新失败，保留最后观测值。请留意观测时间并重试。",
  "exitPending": "实例尚有执行、会话绑定或待核对刷新，暂不能归档。",
  "states": {
    "AVAILABLE": "正常",
    "PARTIAL": "部分可用",
    "UNAVAILABLE": "暂无可用实例",
  ...
  "errors": {
    "CREDENTIAL_OWNERSHIP_MISMATCH": "已验证的授权属于其他账号，可添加为新账号。",
    "CREDENTIAL_DUPLICATE": "该授权实例已经存在，请进入对应账号管理。",
    "CREDENTIAL_UNVERIFIED": "身份尚未验证，请检查授权内容并重试。",
    "CREDENTIAL_IMPORT_EXPIRED": "授权记录已过期，请重新开始授权。",
    "CONFIG_VERSION_CONFLICT": "配置已被修改，已读取最新值。请检查并再次确认保存。",
    "UNAVAILABLE": "操作未完成，请重试。已有账号与实例配置保持不变。"
  }
},
      credentials: {
  "title": "凭证实例",
  ...
  "updateError": "修改被拒绝，请刷新配置并完成所需验证。"
      ...
      openaiUsageSummary: {
        ...
        remainingShort: '余',
        pendingEstimate: '待估算',
        pendingEstimateShort: '待估算',
        details: '详情',
        detailsTitle: 'OpenAI OAuth 用量详情',
        mainAccountLabel: '个主账号',
        drawerClose: '关闭用量详情',
        viewAccounts: '查看这 {count} 个账号',
        windowDataCurrent: '当前数据',
        infoHintFiveHour: '基于最近有效 5 小时窗口估算，覆盖 {count} 个账号',
        infoHintSevenDay: '结合当前与历史数据估算，部分账号使用历史容量参考',
        pendingAccounts: '待同步账号',
        collapsedLabel: '账号池配额',
        totalAccounts: '全部账号',
        includedAccounts: '参与计算',
        excludedAccounts: '已排除',
        usagePercent: '已使用比例',
        remainingPercent: '剩余比例',
        referenceCapacity: '单账号参考容量',
        currentSamples: '当前可信样本',
        estimatedCoverage: '容量覆盖账号',
        updatedAt: '最后更新时间',
        sourceCurrent: '当前数据',
        sourceHistorical: '历史容量',
        sourceMixed: '当前 + 历史',
        sourceUnavailable: '等待有效样本',
        historicalStatus: '历史估算',
        statusCurrent: '数据已同步',
        statusRefreshing: '正在同步',
        statusPendingSync: '部分窗口待同步',
        statusPartial: '部分账号待估算',
        statusUnavailable: '暂无数据',
        statusError: '数据更新失败',
        historicalHint: '容量根据最近有效窗口估算',
        unestimatedHint: '{count} 个账号等待产生有效用量数据后自动估算',
        pendingSyncHint: '{count} 个账号的窗口数据待同步',
        loadFailed: 'OpenAI OAuth 账号池配额加载失败',
        loadFailedCompact: '账号池配额获取失败',
        retry: '重试'
      },
      ...
      testModel: '测试模型',
      testPrompt: '提示词："hi"',
      testContentLabel: '测试内容',
      testContentPlaceholder: '输入要发送给模型的内容，例如：请用一句话介绍自己。',
      testContentHint: '支持多行输入；留空时使用默认测试内容 hi。',
      textTestMode: '模式：文本测试',
      sendingTestContent: '发送测试消息："{prompt}"',
