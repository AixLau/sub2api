export default {
    ...
    riskControl: {
      ...
      semanticReviewHint: '越狱、逆向、网络安全、授权与普通审核不确定的候选固定走平台模型；先用 gpt-5.3-codex-spark，失败后再用 gpt-5.4-mini。',
      ...
      semanticReviewFallbackModelsPlaceholder: '每行一个模型，例如：\ngpt-5.4-mini',
      ...
      semanticReviewReasoningEffort: '推理强度',
