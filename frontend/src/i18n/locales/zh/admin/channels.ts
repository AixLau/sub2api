export default {
    ...
    riskControl: {
      ...
      promptFilterModeHint: '本地运行固定版本的 codex2api 规则。混合模式下命中仅作为复核候选；只有规则模式中的直接用户命中才会由本地拦截。',
      promptFilterModeObserve: '仅观察',
      promptFilterModeWarn: '告警',
      promptFilterModeBlock: '仅规则模式本地拦截',
      promptFilterModeOff: '关闭',
      promptFilterThreshold: '规则评分阈值',
      promptFilterStrictThreshold: 'Strict 评分阈值',
      semanticReviewEnabled: '启用网络安全语义审查',
      semanticReviewHint: '对破限、逆向、凭证窃取和渗透等本地规则候选调用 Codex/mini 模型；模型拒绝才拦截，模型放行后继续普通内容审计。',
