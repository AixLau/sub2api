export default {
    ...
    proxies: {
      ...
      accountNotes: '备注',
      addAccount: '添加账号',
      bindAccountsTitle: '为 {name} 添加已有账号',
      searchAccounts: '搜索账号名称、备注或平台',
      accountsSelected: '已选择 {count} 个账号',
      currentProxy: '当前代理',
      alreadyBound: '已使用当前代理',
      directConnection: '直连',
      shadowProxyInherited: '影子账号继承母账号代理',
      noBindableAccounts: '没有可添加的账号',
      bindSelectedAccounts: '添加 {count} 个账号',
      accountsLoadFailed: '加载账号列表失败',
      accountsBindSuccess: '已添加 {count} 个账号',
      accountsBindPartial: '成功添加 {success} 个，失败 {failed} 个',
      accountsBindFailed: '添加账号失败',
      // Batch import
      standardAdd: '标准添加',
      batchAdd: '快捷添加',
      batchInput: '代理列表',
