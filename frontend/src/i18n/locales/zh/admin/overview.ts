export default {
    ...
    users: {
      ...
      platformOther: '其他',
      balanceHistoryTitle: '用户充值、并发和订阅记录',
      noBalanceHistory: '暂无变动记录',
      allTypes: '全部类型',
      typeBalance: '余额（兑换码）',
      typeAffiliateBalance: '余额（返利转入）',
      typeAdminBalance: '余额（管理员调整）',
      typeWelcomeScratch: '刮刮乐（新用户礼金）',
      typeSurpriseScratch: '刮刮乐（活跃用户惊喜）',
      typeConcurrency: '并发（兑换码）',
      typeAdminConcurrency: '并发（管理员调整）',
      typeSubscription: '订阅（全部来源）',
      subscriptionDuration: '{days} 天',
      subscriptionGroup: '用户组',
      subscriptionNotes: '备注',
      subscriptionNotesEmpty: '-',
      scratchRewardRecord: '刮开后发放',
      subscriptionExpiresAt: '到期：{date}',
