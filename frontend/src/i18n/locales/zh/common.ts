export default {
  common: {
    ...
    supportCommunityTitle: '联系客服',
    supportCommunityIntro: '扫码联系我们，获取使用帮助与服务信息',
    supportQQTab: 'QQ',
    supportWeChatTab: '微信',
    supportQRCodeAlt: '{platform}客服二维码',
    supportQRCodeHint: '请使用 {platform} 扫码',
    supportQRCodeEmptyTitle: '暂未配置{platform}联系方式',
