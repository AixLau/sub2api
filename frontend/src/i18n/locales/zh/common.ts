export default {
  common: {
    ...
    contactSupport: '联系客服',
    getSupport: '点此联系客服',
    supportDialogTitle: '联系人工客服',
    supportDialogIntro: '遇到问题时，请按下面步骤联系人工客服。',
    supportContactLabel: '客服联系方式',
    supportStepCopy: '点击下方“复制客服联系方式”按钮。',
    supportStepOpenApp: '打开对应的聊天软件，例如微信或 QQ。',
    supportStepPaste: '在搜索框中粘贴联系方式，添加客服后说明你遇到的问题。',
    copySupportContact: '复制客服联系方式',
    supportCopied: '联系方式已复制',
    supportCopiedNextStep: '联系方式复制好了。现在请打开对应的聊天软件，在搜索框中粘贴并添加客服。',
    supportCommunityTitle: '用户交流群',
    supportCommunityIntro: '扫码加入群聊，获取使用帮助与最新消息',
    supportQQTab: 'QQ',
    supportWeChatTab: '微信',
    supportQRCodeAlt: '{platform}用户交流群二维码',
    supportQRCodeHint: '请使用 {platform} 扫码加入群聊',
    supportQRCodeEmptyTitle: '暂未配置{platform}群二维码',
    supportQRCodeEmptyDescription: '管理员配置后将在这里显示',
    add: '添加',
