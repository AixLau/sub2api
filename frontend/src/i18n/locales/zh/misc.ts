export default {
  ...
  payment: {
    ...
    admin: {
      ...
      paidUserRetentionHint: '按最近一次余额或订阅额度耗尽时间统计，区间互不重叠',
      totalPaidUsers: '总付费用户',
      totalChurned: '流失合计 {count} 人 · {rate}',
      churnDays7To14: '用完后 7–14 天未付费',
      churnDays15To29: '用完后 15–29 天未付费',
      churnDays30Plus: '用完后 ≥30 天未付费',
      paidChurnFilter: '付费流失区间',
      allPaidUsers: '全部付费流失用户',
      noData: '暂无数据',
      days: '天',
      weeks: '周',
      months: '月',
