export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      pipelineCoverageTitle: 'Gateway Pipeline Coverage',
      ...
      filters: {
        search: 'Search user/key/summary/keyword/category',
        from: 'From',
        to: 'To',
        allGroups: 'All Groups',
    ...
    subscriptions: {
      ...
      adjustHint: 'Use 0 to keep the current expiration. Positive extends, negative shortens (remaining days must be > 0).',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiCodexUserAgentPlaceholder: 'codex-tui/0.140.0 (Windows 10.0.19045; x86_64) WindowsTerminal (codex-tui; 0.140.0)',
      ...
      payment: {
        ...
        field_shopToken: '9.plus Shop Token',
        field_defaultContact: 'Default Contact',
        field_channelId: 'Channel ID',
        ...
        field_nineplusShopTokenHint: 'The token from your 9.plus shop URL, for example XXXX in https://9.plus/shop/XXXX.',
        field_nineplusDefaultContactHint: 'Used when the order has no user contact; 9.plus also uses it as the query password.',
        field_nineplusChannelIdHint: 'Defaults to 10. Usually leave unchanged unless you need a specific 9.plus payment channel.',
  ...
  payment: {
    ...
    rechargeUi: {
      ...
      cardMethodDesc: 'Secure card checkout',
      globalMethodDesc: 'Global payment network',
    ...
    admin: {
      ...
      todayRevenue: 'Today Principal',
      totalRevenue: 'Total Principal',
      todayOrders: 'Today Orders',
      orderCount: 'Order Count',
      avgAmount: 'Average Amount',
      revenue: 'Payment Principal',
      dailyRevenue: 'Daily Payment Principal',
      ...
      weeks: 'weeks',
      months: 'months',
      searchOrders: 'Search order numbers...',
