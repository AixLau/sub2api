export default {
    ...
    proxies: {
      ...
      bindAccountsTitle: 'Add existing accounts to {name}',
      searchAccounts: 'Search by account name, notes, or platform',
      accountsSelected: '{count} accounts selected',
      currentProxy: 'Current Proxy',
      alreadyBound: 'Already using this proxy',
      directConnection: 'Direct connection',
      shadowProxyInherited: 'Shadow account inherits its parent proxy',
      noBindableAccounts: 'No accounts available to add',
      bindSelectedAccounts: 'Add {count} Accounts',
      accountsLoadFailed: 'Failed to load accounts',
      accountsBindSuccess: 'Added {count} accounts',
      accountsBindPartial: 'Added {success} accounts; {failed} failed',
      accountsBindFailed: 'Failed to add accounts',
      name: 'Name',
      protocol: 'Protocol',
      host: 'Host',
      port: 'Port',
