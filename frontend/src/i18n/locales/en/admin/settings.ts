export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiCodexUserAgentHint: 'OAuth Codex upstream requests use the account-level custom UA first, then this system UA, and finally the built-in default. The client User-Agent is not forwarded.',
