export default {
    ...
    riskControl: {
      ...
      semanticReviewHint: 'Jailbreak, reverse-engineering, cyber, authorization, and ordinary-review-uncertain candidates always use platform models: gpt-5.3-codex-spark first, then gpt-5-mini on failure.',
