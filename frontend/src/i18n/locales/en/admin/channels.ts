export default {
    ...
    riskControl: {
      ...
      promptFilterModeHint: 'Pinned codex2api patterns run locally. Observe is the rollout default; only explicit operational Strict matches block.',
      promptFilterModeObserve: 'Observe',
      promptFilterModeWarn: 'Warn',
      promptFilterModeBlock: 'Block operational matches',
