export default {
    ...
    riskControl: {
      ...
      promptFilterModeHint: 'Pinned codex2api patterns run locally. In hybrid mode, matches are review candidates; only direct user matches in rule-only mode can block locally.',
      promptFilterModeObserve: 'Observe',
      promptFilterModeWarn: 'Warn',
      promptFilterModeBlock: 'Block in rule-only mode',
      ...
      semanticReviewEnabled: 'Enable cyber semantic review',
      semanticReviewHint: 'Send jailbreak, reverse-engineering, credential-theft, and intrusion candidates to a Codex/mini model; only a model reject blocks, while an allow continues to ordinary moderation.',
