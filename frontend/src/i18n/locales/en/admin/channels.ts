export default {
    ...
    channels: {
      ...
      form: {
        ...
        reasoningEffortMultipliersHint: 'Apply the multiplier for the final forwarded reasoning effort to the request cost and quota usage.',
        reasoningEffortMultiplierLabel: '{effort} reasoning effort multiplier', reasoningEffortMultiplierDefault: 'Default: 1',
        clearReasoningEffortMultipliers: 'Clear multipliers', reasoningEffortMultiplierPositive: 'The multiplier must be greater than 0', reasoningEffortLevelInvalid: 'Unsupported reasoning effort: {effort}',
    ...
    riskControl: {
      ...
      modePostUpstream: 'Post-upstream',
      modePreUpstream: 'Pre-upstream',
      enforcement: 'Outcome',
      enforcementBlocked: 'Request blocked',
      enforcementAllowed: 'Request forwarded',
      enforcementError: 'Technical failure, forwarded',
      enforcementInferredBlocked: 'Blocked (inferred from action)',
      enforcementInferredAllowed: 'Forwarded (inferred from action)',
      ...
      promptFilterMode: 'Unified rule handling',
      promptFilterModeHint: 'Cyber, authorization, credential theft, malware, and Prompt Injection rules run through the unified keyword/rule review.',
      ...
      semanticReviewModelsConfigRequired: 'Enter API Base URL and API Key first.',
      semanticReviewModelsEmpty: 'No usable models were returned.',
      semanticReviewModelsFetchFailed: 'Unable to fetch models.',
      semanticReviewTestConfigRequired: 'Enter API Base URL, API Key, and select a primary model first.',
      semanticReviewTestSuccess: 'Connection successful; the model is callable.',
      semanticReviewTestFailed: 'Model connection test failed.',
      semanticReviewModelsLoaded: '{count} models loaded',
      ...
      semanticReviewPrimaryModelPlaceholder: 'Enter model ID, for example gpt-4o-mini',
      semanticReviewPrimaryModelHint: 'You may enter a model ID manually. Fetching the model list is optional.',
      semanticReviewFallbackModels: 'Fallback models',
      semanticReviewFallbackModelsPlaceholder: 'Select fallback models',
      semanticReviewFallbackModelsHint: 'Selection order defines fallback priority; number 1 is tried first. Use the arrows to reorder.',
      semanticReviewFallbackMoveUp: 'Increase fallback priority',
      semanticReviewFallbackMoveDown: 'Decrease fallback priority',
      semanticReviewFallbackRemove: 'Remove fallback model',
      semanticReviewAvailableModels: 'Models available from active accounts',
      ...
      semanticReviewMaxAttempts: 'Maximum attempts per model',
      semanticReviewMaxAttemptsHint: 'Includes the initial request. If all attempts fail, the next configured model is tried.',
      semanticReviewMaxOutputTokens: 'Maximum output tokens',
      semanticReviewReasoningEffort: 'Primary review reasoning effort',
      semanticReviewMaxInput: 'Maximum input characters',
      semanticReviewMaxSubmit: 'Maximum submitted text length',
      semanticReviewMaxSubmitHint: 'Upper bound (characters) of the text actually sent to the semantic review model. It directly governs evidence construction and the model request, and the audit record stores the exact submitted text.',
      semanticReviewEscalationEnabled: 'Enable decision escalation',
      semanticReviewEscalationHint: 'When the first review returns review, use a stronger model and fuller direct-user evidence for a second decision.',
      semanticReviewEscalationModel: 'Escalation review model',
	  ...
	  submittedTextStats: 'Submitted text',
	  submittedTextStatsValue: '{runes} / {max} characters',
	  submittedTextTruncated: 'Truncated',
	  ...
	  modelResponseFields: {
		...
		rawVerdict: 'Reviewer Verdict (before policy)',
      ...
      preBlockTechnicalFailures: 'Reviewer Outages',
      preBlockTechnicalFailuresHint: 'Rejected by reviewer unavailability or bad input, not a content verdict',
      ...
      reviewModeRulesOnly: 'Rules only',
      reviewModeRulesOnlyDesc: 'Run keyword and rule checks without calling a model.',
      reviewModeModelOnly: 'Model only',
      reviewModeModelOnlyDesc: 'Skip keyword and rule checks and call the configured model directly.',
      reviewModeRulesAndModel: 'Rules + model',
      reviewModeRulesAndModelDesc: 'Run keyword and rule checks first, then ask the model for a semantic decision.',
