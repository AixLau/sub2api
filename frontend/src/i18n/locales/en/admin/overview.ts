export default {
    ...
    users: {
      ...
      platformOther: 'Other',
      balanceHistoryTitle: 'User Recharge, Concurrency & Subscription History',
      ...
      typeWelcomeScratch: 'Scratch Card (Welcome Gift)',
      typeSurpriseScratch: 'Scratch Card (Active-user Surprise)',
      typeConcurrency: 'Concurrency (Redeem)',
      typeAdminConcurrency: 'Concurrency (Admin)',
      typeSubscription: 'Subscription (All Sources)',
      subscriptionDuration: '{days} days',
      subscriptionGroup: 'Group',
      subscriptionNotes: 'Notes',
      subscriptionNotesEmpty: '-',
      scratchRewardRecord: 'Granted after scratching',
      subscriptionExpiresAt: 'Expires: {date}',
