export default {
  promptAudit: {
    ...
    saveBar: { enabled: 'Enable prompt audit', blocking: 'Synchronous blocking', warnAllowsNextStage: 'Allow Warn results', blockingLatestTurnOnly: 'Only latest input and prior output', storePass: 'Store safe events', dirty: 'Unsaved changes', synced: 'Configuration synced' },
    blockingConfirm: {
    ...
    events: {
      title: 'Audit events', description: 'Review events by identity, route, risk, hash, and time; the detail view shows the full prompt.', decision: 'Decision', risk: 'Risk level', endpoint: 'Endpoint', groupId: 'Group ID', userEmail: 'User email', apiKeyId: 'API Key ID', keyword: 'Keyword',
