    ...
    ops: {
      ...
      errorDetail: {
        ...
        diagnosis: {
          ...
          streamTimeout: 'Stream idle timeout',
          streamTimeoutSummary: 'The stream exceeded its idle threshold. Upstream stalls, network interruptions, or plugin buffering can cause this; the current record does not identify which component is responsible.',
          streamTimeoutEvidence: 'Structured error code: stream_timeout. The displayed 502 does not establish an upstream HTTP 502 response.',
          streamTimeoutAction: 'Compare upstream data arrival, plugin forwarding, and gateway timeout timestamps. Check whether buffering preserves real activity before adjusting timeout settings.',
      ...
      alertRules: {
        ...
        metrics: {
          ...
          contentModerationPendingReviewAge: 'Oldest Pending Moderation Review Age (s)',
        ...
        metricDescriptions: {
          ...
          contentModerationPendingReviewAge: 'Age in seconds of the oldest content moderation record awaiting human review.',
