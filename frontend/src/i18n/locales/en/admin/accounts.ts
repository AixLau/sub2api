export default {
    accounts: {
      instances: {
 deviceManagement: 'Device management', deviceList: 'Devices', runtimeStatus: 'Runtime status', advancedInfo: 'Advanced information', addDevice: 'Add device', configuredCapacity: 'Configured device capacity', currentUsage: 'Current usage', availableBalance: 'Available capacity', effectiveCapacity: 'Effective capacity', createdAt: 'Created', updatedAt: 'Last updated', running: 'Running', reserved: 'Reserved', queued: 'Queued', unresolved: 'Unresolved', waitReasons: 'Wait reasons', reconcileHint: 'Unresolved executions require termination evidence before occupancy can be released.', noRuntimeIssues: 'No runtime issues require attention.',
