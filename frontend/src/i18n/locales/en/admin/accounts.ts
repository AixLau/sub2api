export default {
    accounts: {
      instances: {
 deviceManagement: 'Device management', deviceList: 'Devices', runtimeStatus: 'Runtime status', runtimeTab: 'Runtime status', advancedInfo: 'Advanced information', addDevice: 'Add device', editDevice: 'Edit device', archiveDevice: 'Archive device', archiveConfirm: 'Archive device “{name}”? It will no longer participate in account scheduling.', configuredCapacity: 'Configured device capacity', currentUsage: 'Current usage', availableBalance: 'Available capacity', effectiveCapacity: 'Effective capacity', createdAt: 'Created', updatedAt: 'Last updated', number: 'No.', deviceName: 'Device', status: 'Status', authorization: 'Authorization', credentialExpiry: 'Credential expires', lastRefresh: 'Last refresh', empty: 'No active devices', running: 'Running', reserved: 'Reserved', queued: 'Queued', unresolved: 'Unresolved', orphaned: 'Unresolved', waitReasons: 'Wait reasons', reconcileHint: 'Unresolved executions require termination evidence before occupancy can be released.', noRuntimeIssues: 'No runtime issues require attention.',
"mixedGroup": "This group contains accounts using another scheduler. Select a dedicated group before resuming this account.", "routingPending": "Instance routing is pending activation. Confirm that instance scheduling is enabled and the selected groups are eligible before resuming.",
 attachExisting: 'Add to existing account',
...
"reconcile": "Reconcile unresolved executions (up to 100 shown)", "selectLease": "Select unresolved execution", "evidence": "Reliable termination evidence", "reason": "Resolution reason", "confirmTerminal": "I checked the upstream and confirmed that this execution has reliably terminated.", "releaseConfirmed": "Release confirmed occupancy", "wait": {"PRINCIPAL_CONCURRENCY_EXCEEDED": "Account full", "INSTANCE_CONCURRENCY_EXCEEDED": "Instance full", "USER_CONCURRENCY_EXCEEDED": "User capacity", "REFRESH_WAIT": "Credential refresh", "COOLDOWN": "Instance cooling down", "INSTANCE_UNAVAILABLE": "Instance lifecycle pending", "FAIRNESS_WAIT": "Fair queue"},
 ...
 restart: 'Start authorization again',
  "accountLimit": "Account concurrency limit",
  "name": "Instance name",
  "maxConcurrency": "Instance concurrency limit",
  "add": "Add instance",
  "shrinking": "Reducing capacity; {count} above limit",
  "authorizationHint": "Each instance retains its own authorization and installation identity. Adding an instance preserves the saved account concurrency limit.",
  "pendingCreation": "Authorization verified. Creation is pending; retry to recover the same result.",
  "pendingVerification": "Authorization saved; identity verification is pending. This instance cannot receive requests yet.",
  "resumeOperation": "Confirm and resume creation",
  "createSeparate": "Add as a new account",
  "drain": "Stop new sessions",
  "resume": "Resume requests",
  "remove": "Archive instance safely",
  "reauthorize": "Reauthorize",
  "refreshCredential": "Refresh credentials",
  "bindings": "Active session bindings: {count}",
  "runtime": "Running {running} · Reserved {reserved} · Unresolved {unknown} · Waiting {queued}",
  "savePreview": "Current occupancy {occupied}; new account limit {limit}; expected overage {overhang}. In-flight work will finish naturally.",
  "drainAccount": "Drain account",
  "resumeAccount": "Resume account",
  "archiveAccount": "Archive account",
  "stale": "Refresh failed. Last observed values are retained; check the timestamp and retry.",
  "exitPending": "Execution, session bindings or an unresolved refresh still prevent archival.",
  "states": {
    "AVAILABLE": "Healthy",
    "PARTIAL": "Partially available",
    "UNAVAILABLE": "No available instances",
    "ACTIVE": "Healthy",
    "FULL": "Full",
    "PAUSED": "Paused",
    "DRAINING": "Paused",
  ...
  "errors": {
    "CREDENTIAL_OWNERSHIP_MISMATCH": "This verified authorization belongs to another account. You can add it as a new account.",
    "CREDENTIAL_DUPLICATE": "This authorization instance already exists. Open the corresponding account to manage it.",
    "CREDENTIAL_UNVERIFIED": "Identity is unverified. Check the authorization and retry.",
    "CREDENTIAL_IMPORT_EXPIRED": "The authorization record expired. Start authorization again.",
    "CONFIG_VERSION_CONFLICT": "Configuration changed. Latest values have been loaded; review them and confirm again.",
    "UNAVAILABLE": "The operation did not finish. Retry; existing account and instance settings are unchanged."
  }
},
      credentials: {
  ...
  "updateError": "Update rejected. Reload the current configuration and complete any required verification."
      ...
      openaiUsageSummary: {
        ...
        pendingEstimateShort: 'Pending',
        details: 'Details',
        detailsTitle: 'OpenAI OAuth usage details',
        mainAccountLabel: 'main accounts',
        drawerClose: 'Close usage details',
        viewAccounts: 'View these {count} accounts',
        windowDataCurrent: 'Current data',
        infoHintFiveHour: 'Estimated from the latest valid 5-hour window across {count} accounts',
        infoHintSevenDay: 'Estimated from current and historical data; some accounts use historical capacity',
        pendingAccounts: 'Pending sync',
        collapsedLabel: 'Pool quota',
        totalAccounts: 'All accounts',
        includedAccounts: 'Included',
        excludedAccounts: 'Excluded',
        usagePercent: 'Usage',
        remainingPercent: 'Remaining',
        referenceCapacity: 'Per-account reference',
        currentSamples: 'Trusted current samples',
        estimatedCoverage: 'Accounts estimated',
        updatedAt: 'Last updated',
        sourceCurrent: 'Current data',
        sourceHistorical: 'Historical capacity',
        sourceMixed: 'Current + historical',
        sourceUnavailable: 'Waiting for a valid sample',
        historicalStatus: 'Historical estimate',
        statusCurrent: 'Data synchronized',
        statusRefreshing: 'Synchronizing',
        statusPendingSync: 'Some windows pending sync',
        statusPartial: 'Some accounts unestimated',
        statusUnavailable: 'No data',
        statusError: 'Data update failed',
        historicalHint: 'Capacity is estimated from the latest valid window',
        unestimatedHint: '{count} account(s) will be estimated after valid usage is available',
        pendingSyncHint: '{count} account(s) have window data pending sync',
        loadFailed: 'Failed to load OpenAI OAuth pool quota',
        loadFailedCompact: 'Failed to load pool quota',
        retry: 'Retry'
      },
      ...
      testContentLabel: 'Test content',
      testContentPlaceholder: 'Enter a message for the model, e.g. Introduce yourself in one sentence.',
      testContentHint: 'Multiple lines are supported. Leave blank to use the default message: hi.',
      textTestMode: 'Mode: Text test',
      sendingTestContent: 'Sending test message: "{prompt}"',
