export default {
  plugins: {
    ...
    saveSelectedAccounts: 'Save bindings for {count} accounts',
    updateAccountsSuccess: 'Plugin account bindings updated',
    updateAccountsHint: 'Saving updates routing for subsequent requests without restarting a running plugin. In-flight requests continue normally.',
