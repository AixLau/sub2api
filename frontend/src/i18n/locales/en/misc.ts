export default {
  ...
  payment: {
    ...
    admin: {
      ...
      colUser: 'User',
      topUsers: 'Top Users',
      paidUserRetention: 'Paid User Retention',
      paidUserRetentionHint: 'Mutually exclusive ranges based on the latest balance or subscription exhaustion',
      totalPaidUsers: 'Total Paid Users',
      totalChurned: '{count} churned · {rate}',
      churnDays7To14: 'No payment 7–14 days after exhaustion',
      churnDays15To29: 'No payment 15–29 days after exhaustion',
      churnDays30Plus: 'No payment ≥30 days after exhaustion',
      paidChurnFilter: 'Paid churn range',
      allPaidUsers: 'All paid churn users',
      noData: 'No data',
      days: 'days',
      weeks: 'weeks',
      months: 'months',
