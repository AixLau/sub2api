export default {
  common: {
    ...
    getSupport: 'Get help',
    supportDialogTitle: 'Contact customer support',
    supportDialogIntro: 'If you need help, follow these steps to contact a real support agent.',
    supportContactLabel: 'Support contact',
    supportStepCopy: 'Select “Copy support contact” below.',
    supportStepOpenApp: 'Open the matching chat app, such as WeChat or QQ.',
    supportStepPaste: 'Paste the contact into the search box, add support, and describe your question.',
    copySupportContact: 'Copy support contact',
    supportCopied: 'Contact copied',
    supportCopiedNextStep: 'Contact copied. Now open the matching chat app, paste it into the search box, and add support.',
    supportCommunityTitle: 'Contact Support',
    supportCommunityIntro: 'Scan to contact us for help and service updates',
    supportQQTab: 'QQ',
    supportWeChatTab: 'WeChat',
    supportQRCodeAlt: '{platform} support QR code',
    supportQRCodeHint: 'Scan with {platform}',
    supportQRCodeEmptyTitle: '{platform} contact method is not configured',
    supportQRCodeEmptyDescription: 'It will appear here after an administrator configures it',
    add: 'Add',
  ...
  nav: {
    ...
    merchantIntegrations: 'Merchant SSO',
  },
