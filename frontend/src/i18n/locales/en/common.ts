export default {
  common: {
    ...
    supportCommunityTitle: 'User Community',
    supportCommunityIntro: 'Scan to join a group for help and product updates',
    supportQQTab: 'QQ',
    supportWeChatTab: 'WeChat',
    supportQRCodeAlt: '{platform} community group QR code',
    supportQRCodeHint: 'Scan with {platform} to join the group',
    supportQRCodeEmptyTitle: '{platform} group QR code is not configured',
