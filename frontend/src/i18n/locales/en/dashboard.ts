export default {
  ...
  usage: {
    ...
    phaseUserQueue: 'User queue',
    phaseAccountQueue: 'Account queue',
    phaseRequestWrite: 'Request write',
    phaseResponseHeaders: 'Response headers',
    phaseFirstEvent: 'First semantic event',
