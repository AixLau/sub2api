export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      adjustHint: '填 0 表示不改到期时间；正数延长，负数缩短（缩短后剩余天数需大于0）',
    ...
    settings: {
      ...
      payment: {
        ...
        field_shopToken: '9.plus 店铺 Token',
        field_defaultContact: '默认联系方式',
        field_channelId: '通道 ID',
